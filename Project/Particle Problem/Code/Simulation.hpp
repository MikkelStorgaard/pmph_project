...
class Simulation {
 private:
    ...
    double  dT;                     // [hour]   Size of the time step
    ...
    double  L;                      // [µm]     Length of boundary condition box
    ...
    double  h_colony;               // [µm]    Distance of the cell colony to the hard agar
    ...
    int     forcedInfections;       // "Boolean" to force an infected surface of a given number
    ...
    std::ofstream f_benchMarking;   // Filestream to save benchmarks
 ...
 public:
    ...
    void     CellInitialCount(int B_0);                         // Sets initial density of the bacteria (1/µm^2)
