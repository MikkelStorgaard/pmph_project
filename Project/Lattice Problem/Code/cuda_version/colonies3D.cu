	...
	for (int n = 0; n < nSamplings; n++) {
		...
		for (int t = 0; t < nStepsPerSample; t++) {
			...
			if (GPU_MOVEMENT) {
				...
				cudaDeviceSynchronize();
				ApplyMovement<<<gridSize,blockSize>>>(d_arr_B_new, lambdaB ,d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
				cudaDeviceSynchronize();
				...
				if (r > 0) {
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I0_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I1_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I2_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I3_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I4_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I5_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I6_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I7_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I8_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
					...
					cudaDeviceSynchronize();
					ApplyMovement<<<gridSize,blockSize>>>(d_arr_I9_new, lambdaB, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
					cudaDeviceSynchronize();
				}
				...
				cudaDeviceSynchronize();
				ApplyMovement<<<gridSize,blockSize>>>(d_arr_P_new, lambdaP, d_arr_n_0, d_arr_n_u, d_arr_n_d, d_arr_n_l, d_arr_n_r, d_arr_n_f, d_arr_n_b, nGridZ, nGridXY, experimentalConditions, d_arr_IsActive);
				cudaDeviceSynchronize();
